...
# Flask API接口地址
FLASK_API_BASE = "https://mt.9999.blue/api"
...
=================="""
        ...
        elif choice == '0' and user_tickets > 0:
            # 使用次数支付
...
==================""")
            ...
            out_trade_no = f"MT{current_timestamp}{userid}"
...
==================""")
        ...
        elif choice == '3' and use_point_pay and point_price > 0:
            # 积分支付流程
...
==================""")
        ...
        # 第一步：获取美团登录链接
        sender.replyImage("https://i.imgs.ovh/2025/11/13/CZqNQn.png")
        sender.reply("""=====美团领券=====
普通套券[28-18、38-15、25-8、30-5、33-4、23-9、28-18、23-9]
------------------
请发送美团账号链接
==================""")
        ...
        # 提取token值
        match = re.search(r'token=([^&]+)', mt)
        if match:
            meituan_token = match.group(1)
        else:
            sender.reply("请发送美团ck哦亲")
            exit()
...
==================""")
        ...
        if choice == '1':
            ...
            if proceed_with_coupon:
                try:
                    # 使用Flask API领券
                    all_coupons = fetch_coupons_from_flask_api(mt)
