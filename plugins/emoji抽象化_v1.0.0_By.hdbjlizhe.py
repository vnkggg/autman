#[title: emoji抽象化]
#[create_at: 2025-02-20 17:06:33]
#[author: hdbjlizhe]
#[price: 0.00]
#[rule: ^emoji$]
#[icon:https://bbs.autman.cn/assets/files/2024-04-04/1712221836-209248-afe97f833a73fc2ab40383881dcd6fdc.jpg]
#[admin:false]
#[service: 282617666]
#[version: 1.0.0]
#[description: emoji表情转换，指令：emoji，将文字中适合转换为表情的都转换为emoji表情]
...
if __name__ == "__main__":
    ...
    try:
        ...
        #如果没有安装jieba则安装jieba
        sender.reply("首次使用，正在安装jieba")
        rlt=os.system("pip3 install jieba")
        #判断是否安装成功
        if rlt==0:
            sender.reply("jieba安装成功")
            import jieba
        else:
            sender.reply("jieba安装失败，请手动安装python依赖jieba")
            exit()
    ...
    try:
        ...
        # 如果没有安装pinyin则安装pinyin
        sender.reply("首次使用，正在安装pinyin")
        rlt=os.system("pip3 install pinyin")
        # 判断是否安装成功
        if rlt==0:
            sender.reply("pinyin安装成功")
            import pinyin
        else:
            sender.reply("pinyin安装失败，请手动安装python依赖pinyin")
            exit()
    sender.reply("请输入拟转换的文本信息：") 
    text=sender.listen(120000)
