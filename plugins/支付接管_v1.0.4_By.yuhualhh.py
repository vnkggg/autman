...
回复"q"取消支付""")
        if qr_code_url:
            ...
            try:
                ...
                target_sender.reply(f"二维码链接(长按复制到浏览器打开):\n{qr_code_url}")
        else:
...
回复"q"取消充值""")
        if qr_code_url:
            ...
            try:
                ...
                sender.reply(f"二维码链接(长按复制到浏览器打开):\n{qr_code_url}")
        else:
