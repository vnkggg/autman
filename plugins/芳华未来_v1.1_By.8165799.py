# [rule: ^(芳华未来|芳华)(登录|登陆)$|^登(录|陆)(芳华未来|芳华)$|^(芳华未来|芳华)(查询|管理)$|^(查询|管理)(芳华未来|芳华)$|^(芳华未来|芳华)清理$|^(芳华未来|芳华)授权$|^(芳华未来|芳华)教程$|^(芳华未来|芳华)通知 ?(.*)$|^清理(芳华未来|芳华)$|^(芳华未来|芳华)广播 ?(.*)$]
# [disable:false]
...
# [description: 芳华未来代挂提交<br>1. 指令：芳华未来登录、芳华未来管理、芳华未来查询、芳华未来授权。<br>2. 用户提交 手机号#密码<br>3. 支持查询接口实时获取当前积分和账号存活状态。<br>4. 售后群1003974618。 售后联系：QQ 8165799<br>]
...
logger = logging.getLogger('fang_hua_wei_lai_plugin')
...
try:
    middleware.bucketSet(bucket='fang_hua_wei_lai_sender', key=userid, value=str(senderID))
    middleware.bucketSet(bucket='fang_hua_wei_lai_imtype', key=userid, value=str(sender.getImtype()))
except:
    pass

# ===================== 插件配置参数 =====================
# [param: {"required":true,"key":"fang_hua_wei_lai.panel_type","bool":false,"placeholder":"qinglong/daidai","name":"对接面板类型","desc":"qinglong=青龙面板 daidai=呆呆面板"}]
# [param: {"required":true,"key":"fang_hua_wei_lai.fang_hua_wei_lai_qlname","bool":false,"placeholder":"Host丨ClientID/AppKey丨Secret","name":"对接系统配置","desc":"青龙:URL丨ID丨Secret 呆呆:URL丨Key丨Secret"}]
# [param: {"required":true,"key":"fang_hua_wei_lai.fang_hua_wei_lai_osname","bool":false,"placeholder":"默认:fhb","name":"系统变量名","desc":"系统容器内变量名(默认为fhb)"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.epay_alipay","bool":true,"name":"易支付支付宝","desc":"启用易支付支付宝通道收款"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.epay_wxpay","bool":true,"name":"易支付微信","desc":"启用易支付微信通道收款"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.epay_qqpay","bool":true,"name":"易支付QQ","desc":"启用易支付QQ通道收款"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.epay_url","bool":false,"placeholder":"如 http://pay.xxx.com/","name":"易支付网关","desc":"易支付接口网关地址(需带http及结尾/)"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.epay_pid","bool":false,"placeholder":"","name":"易支付商户ID","desc":"易支付的PID"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.epay_key","bool":false,"placeholder":"","name":"易支付商户密钥","desc":"易支付的KEY密钥"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.enable_zsm","bool":true,"name":"个人微信收款","desc":"在支付菜单中增加个人微信收款码方式"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.zsm","bool":false,"placeholder":"http://xxxx.co/xxx.jpg","name":"微信收款码链接","desc":"填写个人微信收款码直链，不填则不开启"}]
# [param: {"required":true,"key":"fang_hua_wei_lai.zsVipmoney","bool":false,"placeholder":"例:0.88,不填为0元","name":"上车价格","desc":"上车价格(单位:元)/月"}]
# [param: {"required":true,"key":"fang_hua_wei_lai.zscoin","bool":false,"placeholder":"不填为关闭积分支付","name":"积分开通","desc":"授权一个月需要多少积分"}]
# [param: {"required":true,"key":"fang_hua_wei_lai.enable_proxy","bool":true,"name":"启用代理","desc":"是否启用代理功能"}]
# [param: {"required":false,"key":"fang_hua_wei_lai.proxy_pool_url","bool":false,"placeholder":"http://代理池API地址","name":"代理池地址","desc":"代理API服务地址"}]
# [param: {"required":true,"key":"fang_hua_wei_lai.points_bucket","bool":false,"placeholder":"默认使用dd_sign_points","name":"积分桶名称","desc":"存储用户积分的桶名称"}]
# [param: {"required":true,"key":"fang_hua_wei_lai.enable_remark","bool":true,"name":"启用备注功能","desc":"是否启用账号备注功能"}]
# [param: {"required":true,"key":"fang_hua_wei_lai.reminder_days","bool":false,"placeholder":"例:2","name":"到期提醒天数","desc":"到期前多少天开始发送提醒通知"}]

def getusercontent():
    """获取插件完整配置"""
    panel_type = middleware.bucketGet('fang_hua_wei_lai', 'panel_type') or 'qinglong'
    panel_type = panel_type.lower()
    
    env_qlconfig = middleware.bucketGet('fang_hua_wei_lai', 'fang_hua_wei_lai_qlname') or ''
    env_name = middleware.bucketGet('fang_hua_wei_lai', 'fang_hua_wei_lai_osname') or 'fhb'
    
    if not env_qlconfig:
        sender.reply("❌ 配置错误：请在插件配置中填写【对接系统配置】(面板信息)。")
        exit(0)
    
    fang_hua_wei_lai_managecommand = middleware.bucketGet('fang_hua_wei_lai', 'fang_hua_wei_lai_managecommand') or '芳华未来管理'
    fang_hua_wei_lai_querycommand = middleware.bucketGet('fang_hua_wei_lai', 'fang_hua_wei_lai_querycommand') or '芳华未来查询'
    fang_hua_wei_lai_signcommand = middleware.bucketGet('fang_hua_wei_lai', 'fang_hua_wei_lai_signcommand') or '芳华未来登录'
    
    enable_proxy = (middleware.bucketGet('fang_hua_wei_lai', 'enable_proxy') or 'false').lower() == 'true'
    proxy_pool_url = middleware.bucketGet('fang_hua_wei_lai', 'proxy_pool_url') or ''
    points_bucket = middleware.bucketGet('fang_hua_wei_lai', 'points_bucket') or 'dd_sign_points'
    enable_remark = (middleware.bucketGet('fang_hua_wei_lai', 'enable_remark') or 'false').lower() == 'true'
    
    randommanagecommand = fang_hua_wei_lai_managecommand
    randomquerycommand = fang_hua_wei_lai_querycommand
    randomsigncommand = fang_hua_wei_lai_signcommand
    
    zsVipmoney = Decimal(middleware.bucketGet('fang_hua_wei_lai', 'zsVipmoney') or '0')
    zscoin = int(middleware.bucketGet('fang_hua_wei_lai', 'zscoin') or '0')
    reminder_days = int(middleware.bucketGet('fang_hua_wei_lai', 'reminder_days') or '2')
    
    # 个人微信收款配置
    enable_zsm = (middleware.bucketGet('fang_hua_wei_lai', 'enable_zsm') or 'false').lower() == 'true'
    zsm = middleware.bucketGet('fang_hua_wei_lai', 'zsm') or ''
    
    # 易支付配置提取
    epay_url = middleware.bucketGet('fang_hua_wei_lai', 'epay_url') or ''
    epay_pid = middleware.bucketGet('fang_hua_wei_lai', 'epay_pid') or ''
    epay_key = middleware.bucketGet('fang_hua_wei_lai', 'epay_key') or ''
    epay_alipay = (middleware.bucketGet('fang_hua_wei_lai', 'epay_alipay') or 'true').lower() == 'true'
    epay_wxpay = (middleware.bucketGet('fang_hua_wei_lai', 'epay_wxpay') or 'false').lower() == 'true'
    epay_qqpay = (middleware.bucketGet('fang_hua_wei_lai', 'epay_qqpay') or 'false').lower() == 'true'

    return {
        'panel_type': panel_type,
        'env_name': env_name,
        'env_qlconfig': env_qlconfig,
        'fang_hua_wei_lai_managecommand': fang_hua_wei_lai_managecommand,
        'fang_hua_wei_lai_querycommand': fang_hua_wei_lai_querycommand,
        'fang_hua_wei_lai_signcommand': fang_hua_wei_lai_signcommand,
...
def get_owner_user_id(account, fallback_userid=None):
    ...
    try:
        ...
        pass
    try:
        for owner in middleware.bucketAllKeys(bucket='fang_hua_wei_lai_user'):
            try:
...
def send_daily_admin_report(report_data, force_send=False, notify_status=False):
    ...
    if not force_send and middleware.bucketGet('fang_hua_wei_lai_runtime', report_key):
        if notify_status:
    ...
    if framework_sent:
        try:
            middleware.bucketSet('fang_hua_wei_lai_runtime', report_key, "framework")
        except Exception:
            pass
        if notify_status:
...
def batch_verify_account_ck(tasks, max_workers=MAINTENANCE_CK_MAX_WORKERS):
    # 芳华未来账密查询接口偶发波动时容易误判。为避免误推用户，默认不做账号失效推送。
    return {}

def send_user_notice(user_id, msg, title="芳华未来通知"):
    try:
        imtype = middleware.bucketGet(bucket='fang_hua_wei_lai_imtype', key=str(user_id)) or sender.getImtype()
    except:
    ...
    targets = []
    try:
        saved_sender = middleware.bucketGet(bucket='fang_hua_wei_lai_sender', key=str(user_id))
        if saved_sender:
...
def safe_send_message(user_id, msg, log_context=""):
    ok, err = send_user_notice(user_id, msg, "芳华未来提醒")
    if not ok:
        logger.warning(f"消息发送失败 {log_context}: {err}")
    return ok

def parse_panel_fang_hua_wei_lai_remark(remarks):
    try:
    ...
    try:
        ...
        for env in sys_api.get_all_envs():
            if env.get('name') != config['env_name']:
                continue
            stats['scanned'] += 1
            info = parse_panel_fang_hua_wei_lai_remark(env.get('remarks') or env.get('remark') or '')
            if not info:
                continue
            AccountManager.add_account(info['user'], info['account'])
            middleware.bucketSet(bucket='fang_hua_wei_lai_auth', key=info['account'], value=info['auth_date'])
        ...
        logger.warning(f"芳华未来面板授权回写本地失败: {e}")
    return stats
...
class FanghuaClient:
    ...
    def __init__(self, credential):
        ...
        self.mobile, self.password, self.jpush_id, self.jpush_user_supplied = self.parse_credential(self.credential)
        if not self.jpush_id:
            self.jpush_id = self.generate_jpush_id(self.mobile)
            self.credential = f"{self.mobile}#{self.password}#{self.jpush_id}"
        self.nickname = ""
        self.user_id = ""
        self.uid = self.mobile or self.legacy_key()
        self.uid_type = "mobile" if self.mobile else "credential_md5"
        self.aliases = []
        self.web_token = ""
        self.app_token = ""
        self.score = "0"
    ...
    def parse_credential(raw):
        ...
        if len(parts) not in (2, 3) or not parts[0] or not parts[1]:
            raise ValueError("格式错误，正确格式：手机号#密码 或 手机号#密码#jpushId")
        if not looks_like_mobile(parts[0]):
            raise ValueError("手机号格式错误，请使用：手机号#密码")
        jpush_id = parts[2] if len(parts) == 3 and parts[2].lower() != "auto" else ""
        return parts[0], parts[1], jpush_id, bool(jpush_id)

    @staticmethod
    def generate_jpush_id(phone):
        seed = f"{phone}:{time.time()}:{random.random()}:{uuid.uuid4()}"
        return f"1a0018970ae5{hashlib.md5(seed.encode()).hexdigest()[:16]}"
    ...
    def _get_proxy(self):
        ...
        try:
            ...
            logger.warning(f"芳华未来查询获取代理失败: {e}")
        return None

    def _request_api(self, method, path, body=None, token="", timeout=20, max_retries=3):
        last_exc = None
    ...
    def legacy_key(self):
        return hashlib.md5(str(self.credential).encode()).hexdigest()[:8]

    def login(self):
        body = {
            "phone": self.mobile,
            "password": self.password,
            "jpushId": self.jpush_id,
            "loginType": self.LOGIN_TYPE,
            "source": self.LOGIN_SOURCE,
        }
        resp = self._request_api("POST", "/app/app/login", body=body)
        if resp.get("code") == 200 and resp.get("token"):
            self.app_token = str(resp.get("token"))
            user = resp.get("user") if isinstance(resp.get("user"), dict) else {}
            self.user_id = str(user.get("userId") or "").strip()
            self.nickname = str(user.get("name") or user.get("nickName") or "").strip()
            if user.get("integral") is not None:
                self.score = str(user.get("integral") or "0")
            if not self.user_id:
                raise RuntimeError("登录成功但 userId 为空")
            return self.app_token
        raise RuntimeError(resp.get("msg") or resp.get("message") or f"登录失败: {resp}")

    def refresh_profile(self):
        token = self.app_token or self.login()
        resp = self._request_api("GET", "/app/user/getUserInfo", token=token)
        if resp.get("code") != 200 and self.mobile and self.password:
            token = self.login()
            resp = self._request_api("GET", "/app/user/getUserInfo", token=token)
        if resp.get("code") != 200:
            raise RuntimeError(resp.get("msg") or resp.get("message") or f"查询积分失败: {resp}")
        user = resp.get("user") if isinstance(resp.get("user"), dict) else {}
        self.user_id = str(user.get("userId") or self.user_id or "").strip()
        self.nickname = str(user.get("name") or self.nickname or "").strip()
        self.score = str(user.get("integral", self.score) or "0")
        self.uid = self.mobile
        self.uid_type = "mobile"
        return resp

    def get_info(self):
        """返回: (网络是否成功, 账号是否有效, 当前积分, 提示信息)"""
        try:
            self.refresh_profile()
            msg = f"🪙 当前积分: {self.score}"
    ...
    def check_info(self):
        ...
        return {
            "nickname": self.nickname or f"芳华未来_{display_id}",
            "phone": self.mobile,
            "acc_key": self.mobile,
            "acc_type": "mobile",
            "aliases": [self.legacy_key()],
            "legacy_key": self.legacy_key(),
            "final_token": self.credential,
            "mobile": self.mobile,
            "score": self.score,
            "exchange": self.exchange,
            "web_token": self.app_token,
        }
...
class RemarkManager:
    ...
    def get_account_remark(user_id, account_id):
        try:
            remark_data = middleware.bucketGet(bucket='fang_hua_wei_lai_remarks', key=f'{user_id}_{account_id}')
    ...
    def set_account_remark(user_id, account_id, remark):
        try:
            ...
            if remark_clean:
                middleware.bucketSet(bucket='fang_hua_wei_lai_remarks', key=f'{user_id}_{account_id}', value=remark_clean)
                return remark_clean
            return ""
        except: return ""
    ...
    def delete_account_remark(user_id, account_id):
        try:
            middleware.bucketDel(bucket='fang_hua_wei_lai_remarks', key=f'{user_id}_{account_id}')
            return True
        except: return False
...
class AccountManager:
    ...
    def get_accounts(user_id):
        try:
            value = middleware.bucketGet(bucket='fang_hua_wei_lai_user', key=str(user_id))
            if not value: return []
    ...
    def add_account(user_id, account):
        try:
            ...
            if account not in accounts:
                ...
                middleware.bucketSet(bucket='fang_hua_wei_lai_user', key=str(user_id), value=str(accounts))
                return True
            return False
        except: return False
        ...
        try:
            ...
            if account in accounts:
                ...
                if accounts:
                    ...
                    middleware.bucketDel(bucket='fang_hua_wei_lai_user', key=str(user_id))
                return True
            return False
        except: return False
    ...
    def update_account_token(account, token):
        try:
            ...
            middleware.bucketSet(bucket='fang_hua_wei_lai_token', key=str(account), value=encrypted_token)
            return True
        except: return False
    ...
    def update_account_mobile(account, mobile):
        try:
            mobile = str(mobile or "").strip()
            if mobile:
                middleware.bucketSet(bucket='fang_hua_wei_lai_mobile', key=str(account), value=mobile)
                return True
            return False
        except: return False
    ...
    def get_account_mobile(account):
        try:
            return middleware.bucketGet(bucket='fang_hua_wei_lai_mobile', key=str(account)) or ""
        except: return ""
    ...
    def update_account_web_token(account, web_token):
        try:
            ...
            if web_token:
                middleware.bucketSet(bucket='fang_hua_wei_lai_web_token', key=str(account), value=encrypt_token(web_token))
                return True
            return False
        except: return False
    ...
    def get_account_web_token(account):
        try:
            enc = middleware.bucketGet(bucket='fang_hua_wei_lai_web_token', key=str(account))
    ...
    def get_token(account):
        try:
            enc = middleware.bucketGet(bucket='fang_hua_wei_lai_token', key=str(account))
    ...
    def get_all_users():
        try:
            users = middleware.bucketAllKeys(bucket='fang_hua_wei_lai_user')
            user_list = []
            for user in users:
    ...
    def migrate_account(user_id, old_account, new_account, new_token, remark=""):
        try:
            ...
            old_vip = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=old_account)
            new_vip = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=new_account)
            if old_vip and (not new_vip or str(old_vip) > str(new_vip)):
                middleware.bucketSet(bucket='fang_hua_wei_lai_auth', key=new_account, value=old_vip)

            old_bind_date = middleware.bucketGet(bucket='fang_hua_wei_lai_bind_date', key=old_account)
            if old_bind_date and not middleware.bucketGet(bucket='fang_hua_wei_lai_bind_date', key=new_account):
                middleware.bucketSet(bucket='fang_hua_wei_lai_bind_date', key=new_account, value=old_bind_date)
            ...
            middleware.bucketSet(bucket='fang_hua_wei_lai_user', key=str(user_id), value=str(new_accounts))

            AccountManager.update_account_token(new_account, new_token)
            try: middleware.bucketDel(bucket='fang_hua_wei_lai_token', key=old_account)
            except: pass
            try: middleware.bucketDel(bucket='fang_hua_wei_lai_mobile', key=old_account)
            except: pass
            try: middleware.bucketDel(bucket='fang_hua_wei_lai_web_token', key=old_account)
            except: pass
            try: middleware.bucketDel(bucket='fang_hua_wei_lai_auth', key=old_account)
            except: pass
            return True
        except Exception as e:
    ...
    def find_migration_source(user_id, new_account, aliases=None, acc_type="", legacy_key=""):
        try:
            ...
            for old_account in AccountManager.get_accounts(user_id):
                ...
                old_client = FanghuaClient(old_token)
...
class SystemAPI:
    ...
    def sync_env(self, token, phone, remark="", auth_time="", owner_user_id=None):
        ...
        try:
            ...
            # 环境变量只保存账密数据；备注写入 remarks，避免用户备注影响脚本读取。
            ql_value = f"{token}"
            
            safe_phone = mask_mobile(phone)
            remarks_parts = [f'芳华未来:{safe_phone}']
            ...
            remarks_parts.extend([f'用户:{owner_user}', f'ID:{phone}', '芳华未来提交'])
...
def process_single_account_query(account, index, total_count, account_remarks):
    try:
        ...
        accountVip = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=account)
        ...
        if full_token and len(full_token) >= 10:
            try:
                client = FanghuaClient(full_token)
                saved_app_token = AccountManager.get_account_web_token(account)
                if saved_app_token:
                    client.app_token = saved_app_token
                ...
                if info.get("web_token"):
                    AccountManager.update_account_web_token(account, info["web_token"])
                 
                status_text = f"🪙 当前积分: {info.get('score', client.score)}"
...
==================""")
        ...
        for i, acc in enumerate(accounts, 1):
            ...
            vip = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=acc)
            if not vip:
                vip_tag = '⚠️未授权'
            elif vip < today_time:
                vip_tag = '❌已过期'
...
def notify_authorized_users():
    ...
    content = ""
    match = re.search(r'^\s*((?:芳华未来|芳华)(?:广播|通知))\s*(.*)$', usermessage, re.S)
    if match:
        content = match.group(2).strip()
    
    if not content:
        sender.reply("❌ 请输入通知内容，例如：芳华未来通知 系统维护中")
        return
    ...
    try:
        ...
        for uid in all_users:
            ...
            for acc in user_accounts:
                vip_date = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=str(acc))
                if vip_date and vip_date >= today:
                    has_auth = True
                    break
            
            if has_auth:
                ok, err = send_user_notice(uid, f"📢 【芳华未来管理员通知】\n\n{content}", "芳华未来管理员通知")
                if ok:
                    success_count += 1
                    time.sleep(0.3)
                else:
                    fail_count += 1
                    logger.warning(f"芳华未来管理员通知发送失败 {uid}: {err}")
...
def parse_bind_input_line(line, default_remark="", submit_mode="password"):
    ...
    if len(parts) in (2, 3) and looks_like_mobile(parts[0]):
        return FanghuaClient("#".join(parts)), default_remark
    if len(parts) in (3, 4) and looks_like_mobile(parts[1]):
        return FanghuaClient("#".join(parts[1:])), parts[0] or default_remark

    return FanghuaClient(raw), default_remark
...
==================""")
        ...
        for line in token_lines:
            try:
                ...
                bind_result = process_account_binding(
                    final_token_str,
                    acc_id,
                    nick,
                    line_remark,
                    ...
                    legacy_key,
                    mobile=mobile,
                    web_token=info_res.get("web_token") or getattr(client, "app_token", ""),
                    silent=(len(token_lines) > 1),
                )
...
def process_account_binding(full_token, unique_id, nickname, remark="", aliases=None, acc_type="", legacy_key="", mobile="", web_token="", silent=False):
    try:
        ...
        if is_new:
            try: middleware.bucketSet(bucket='fang_hua_wei_lai_bind_date', key=account, value=str(datetime.now().date()))
            except: pass
        ...
        if choice == '1':
            ...
            if process_payment(months, accountVip, token, account, remark):
                try:
                    ...
                    try: middleware.bucketSet(bucket='fang_hua_wei_lai_auth', key=account, value=new_auth_time)
                    except: pass

                    today_date = datetime.now().date()
                    for d in range(config['reminder_days'] + 1):
                        remind_key = f"{userid}_{account}_{today_date - timedelta(days=d)}"
                        try: middleware.bucketDel('fang_hua_wei_lai_remind_log', remind_key)
                        except: pass
            ...
            if get_user_input() == 'y':
                try:
                    ...
                    try: middleware.bucketDel(bucket='fang_hua_wei_lai_token', key=account)
                    except: pass
                    try: middleware.bucketDel(bucket='fang_hua_wei_lai_mobile', key=account)
                    except: pass
                    try: middleware.bucketDel(bucket='fang_hua_wei_lai_web_token', key=account)
                    except: pass
                    try: middleware.bucketDel(bucket='fang_hua_wei_lai_auth', key=account)
                    except: pass
...
def process_payment(months, accountVip, token, account, remark=""):
    ...
    try:
        ...
        if opt['type'] == 'epay':
            out_trade_no = f"JYXE_{int(time.time())}_{userid}_{random.randint(1000,9999)}"
...
def batch_auth_selected(accounts, account_remarks):
    ...
    try:
        ...
        if opt['type'] == 'epay':
            out_trade_no = f"JYXE_BATCH_{int(time.time())}_{userid}_{random.randint(1000,9999)}"
            formatted_money = f"{float(opt['amount']):.2f}"
            channel_name = "支付宝" if opt['channel'] == 'alipay' else ("微信支付" if opt['channel'] == 'wxpay' else "QQ钱包")
    ...
    for account in accounts:
        try:
            ...
            try: middleware.bucketSet('fang_hua_wei_lai_auth', account, new_date)
            except: pass
...
def clean_expired_accounts(force_report=False):
    panel_sync = sync_local_auth_from_panel()
    users = middleware.bucketAllKeys(bucket='fang_hua_wei_lai_user')
    manual_clean_commands = ['芳华未来清理', '清理芳华未来', '芳华清理', '清理芳华']
    if not users:
        if sender.isAdmin() and (force_report or usermessage in manual_clean_commands):
            sender.reply("=====执行结果=====\n📭 暂无用户数据")
        return {
        ...
        try:
            ...
            for account_item in context["accounts"]:
                ...
                if days_diff >= 0:
                    ...
                    # 芳华未来不做 CK/配置失效提醒，避免接口不稳定导致误推。
                    is_ck_valid = True
                    
                    if is_ck_valid and 0 <= days_diff <= reminder_days_cfg:
                        remind_key = f"{user}_{account}_{today_date}"
                        has_reminded = middleware.bucketGet('fang_hua_wei_lai_remind_log', remind_key)
...
=================="""
                            if safe_send_message(user, msg, f"到期提醒 {user}-{account}"):
                                try: middleware.bucketSet('fang_hua_wei_lai_remind_log', remind_key, "1")
                                except: pass
                                reminded_count += 1
                    continue
...
=================="""
            ...
            if user_has_change:
                if valid_accounts:
                    try: middleware.bucketSet(bucket='fang_hua_wei_lai_user', key=str(user), value=str(valid_accounts))
                    except: pass
                else:
                    try: middleware.bucketDel(bucket='fang_hua_wei_lai_user', key=str(user))
                    except: pass
    ...
    for user in users:
        for account in AccountManager.get_accounts(user):
            try:
                ...
                if not token:
                    stats["no_token"] += 1
                vip = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=account)
                if not vip:
    ...
    if choice == '1':
        ...
        if len(users) <= 1 and total_accounts > 5:
            sender.reply(
                ...
                "请先恢复 fang_hua_wei_lai_user 归属表，或使用 [2] 同步指定用户账号。"
            )
            return
...
def admin_auth_all_users():
    ...
    for user in all_users:
        ...
        for account in accounts:
            try:
                account = str(account)
                accVip = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=account)
                new_vip = empower(accVip, days)
                try: middleware.bucketSet(bucket='fang_hua_wei_lai_auth', key=account, value=new_vip)
                except: pass
...
def admin_auth_specific_user():
    ...
    for i, acc in enumerate(target_accounts, 1):
        acc = str(acc)
        accVip = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=acc)
    ...
    for acc in selected_accs:
        ...
        accVip = middleware.bucketGet(bucket='fang_hua_wei_lai_auth', key=acc)
        new_vip = empower(accVip, days)
        try: middleware.bucketSet(bucket='fang_hua_wei_lai_auth', key=acc, value=new_vip)
        except: pass
...
try:
    ...
    elif re.match(r'^(芳华未来|芳华)(通知|广播)\s*', command):
        notify_authorized_users()
    elif command in ['芳华未来登录', '芳华未来登陆', '登录芳华未来', '登陆芳华未来', '芳华登录', '芳华登陆', '登录芳华', '登陆芳华']:
        bindaccount()
    elif command in ['芳华未来管理', '管理芳华未来', '芳华管理', '管理芳华']:
       xy_manage()
    elif command in ['芳华未来查询', '查询芳华未来', '芳华查询', '查询芳华']:
        cxs()
    elif command in ['芳华未来清理', '清理芳华未来', '芳华清理', '清理芳华']:
        try:
            report_data = clean_expired_accounts()
        except Exception:
        ...
        send_daily_admin_report(report_data, force_send=True, notify_status=True)
    elif command in ['芳华未来授权', '芳华授权']:
        admin_auth_options()
    elif command in ['芳华未来教程', '芳华教程']:
        show_tutorial()
