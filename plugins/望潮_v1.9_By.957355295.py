# [pin:true]
# [public:true]
# [rule: ^(望潮管理|管理望潮|望潮查询|查询望潮|望潮登录|望潮登陆|登录望潮|登陆望潮|望潮授权|授权望潮|望潮教程|望潮授权检测|望潮通知|通知望潮|望潮对接测试|更新青龙|望潮更新青龙|望潮删除|删除望潮)$]
# [cron: 0 5 0 * * *]
# [disable:false]
...
# [description: 望潮插件 青龙/呆呆面板对接<br>提供对接运行，0.5一个号，30个起步<br>1.1更新了WXPUSH通知<br>1.4新增批量删除功能<br>1.6更新管理员一键授权<br>1.7添加了码支付功能<br>1.8支持呆呆面板（DaiDaiPanel）]
...
DOCKING_API = 'https://wwwcc.heimao.cloud/api'
