...
#[public: true]
#[price: 0]
#[description: 将autman数据桶/插件代码导出到呆呆曼！<br>指令：数据导出|代码导出|插件迁移<br>支持多数据桶、通配符匹配及插件批量迁移]
...
# [param: {"required":true,"key":"s_export.api_url","bool":false,"placeholder":"http://192.168.1.1:5678","name":"呆呆曼API地址","desc":"远程服务器API地址"}]
# [param: {"required":true,"key":"s_export.api_user","bool":false,"placeholder":"邮箱/账号","name":"目标账号","desc":"呆呆曼登录账号(邮箱)"}]
# [param: {"required":true,"key":"s_export.api_pwd","bool":false,"placeholder":"密码","name":"目标密码","desc":"呆呆曼登录密码"}]
