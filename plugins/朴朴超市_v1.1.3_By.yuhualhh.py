...
# [author: yuhualhh]
# [service: ]
# [description: <br>❶朴朴超市资产查询以及对接青龙面板代挂插件，支持微信扫码登录、批量刷新Token、管理、查询、授权、检测授权过期以及Token失效并推送等功能<br>❷部分功能的实现需自行添加计划任务伪装管理员定时，了解如何添加计划任务请看移动云盘插件介绍，关于指令『朴朴检测』与『朴朴清理』定时『30 18 * * *』，关于指令『朴朴一键刷新』定时『0 9,21 * * *』]
